...
public class ExternalStorageDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final String message = String.format(VLCApplication.getAppResources().getString(R.string.ml_external_storage_msg,
                ((VLCApplication)getActivity().getApplication()).getConfig().getAppName()), uuid);
