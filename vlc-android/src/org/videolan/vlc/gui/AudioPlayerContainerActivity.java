...
public class AudioPlayerContainerActivity extends BaseActivity implements PlaybackService.Client.Callback {
    ...
    protected void initAudioPlayerContainerActivity() {
        ...
        mToolbar.setBackgroundColor(((VLCApplication)getApplication()).getConfig().getColorPrimary());
    ...
    public void showTipViewIfNeeded(final int stubId, final String settingKey) {
        ...
        if (vsc != null && !mSettings.getBoolean(settingKey, false) && !VLCApplication.showTvUi()) {
            ...
            GradientDrawable shapeDrawable = (GradientDrawable)getResources().getDrawable(R.drawable.button_oval);
            shapeDrawable.setColor(config.getColorPrimary());
            okGotIt.setBackground(shapeDrawable);
    ...
    private void showProgressBar() {
        ...
        if (vsc != null) {
            ...
            mScanProgressBar.getProgressDrawable().setColorFilter(
