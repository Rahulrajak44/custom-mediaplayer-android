...
public class VideoListAdapter extends SortableAdapter<MediaWrapper, VideoListAdapter.ViewHolder> implements Filterable {
    ...
    VideoListAdapter(IEventsHandler eventsHandler, Config config) {
        super();
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.binding.setVariable(BR.bgColor, mListMode &&  isSelected ? ColorUtils.setAlphaComponent(config.getColorAccent(), 0x64) : ContextCompat.getColor(holder.itemView.getContext(), R.color.transparent));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnFocusChangeListener {
        ...
        public ViewHolder(View itemView) {
            ...
            progressBar = (ProgressBar) itemView.findViewById(R.id.ml_item_progress);
            itemSeen = (ImageView) itemView.findViewById(R.id.ml_item_seen);
            itemSeen.setColorFilter(config.getColorAccent(), PorterDuff.Mode.SRC_IN);
            progressBar.getProgressDrawable().setColorFilter(config.getColorAccent(), android.graphics.PorterDuff.Mode.SRC_IN);
        ...
        private void setOverlay(boolean selected) {
            ...
            thumbView.setColorFilter(config.getColorAccent(), android.graphics.PorterDuff.Mode.SRC_IN);
        }
        ...
        private void setViewBackground(boolean highlight) {
            itemView.setBackgroundColor(highlight ? config.getColorPrimary() : UiTools.ITEM_FOCUS_OFF);
        }
    }
