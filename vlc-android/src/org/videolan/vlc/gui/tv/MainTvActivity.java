...
public class MainTvActivity extends BaseTvActivity implements OnItemViewSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBrowseFragment.setBadgeDrawable(ContextCompat.getDrawable(this, R.drawable.app_icon));
        ...
        if (AndroidDevices.hasPlayServices()) {
            ...
            mBrowseFragment.setSearchAffordanceColor(((VLCApplication)getApplication()).getConfig().getColorAccent());
        }

        mBrowseFragment.setBrandColor(((VLCApplication)getApplication()).getConfig().getColorPrimary());
    ...
    private class AsyncUpdate extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            mOtherAdapter.add(new CardPresenter.SimpleCard(ID_ABOUT, getString(R.string.about), getString(R.string.app_name)+" "+ BuildConfig.VERSION_NAME, R.drawable.app_icon));
            mOtherAdapter.add(new CardPresenter.SimpleCard(ID_LICENCE, getString(R.string.licence), R.drawable.app_icon));
                        ...
                        public void run() {
                            if (mNowPlayingCard == null) {
                                if (cover != null)
                                    ...
                                    mNowPlayingCard = new CardPresenter.SimpleCard(MusicFragment.CATEGORY_NOW_PLAYING, display, R.drawable.app_icon);
                                ...
                                if (cover != null)
                                    ...
                                    mNowPlayingCard.setImageId(R.drawable.app_icon);
                            }
